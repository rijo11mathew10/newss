    ...
    return (
        ...
        <div  className="bg-slate-900 flex items-center justify-center h-screen">
            <section className="bg-white pt-20 px-4 pb-8 flex flex-col justify-between h-screen md:h-auto md:w-[500px] md:rounded-2xl md:p-12">
              ...
              <buton onClick={()=> setSuccess(false)}
               style={{backgroundColor:'hsl(234,29%,20%'}} className="py-3 px-4 w-full text-white font-bold hover:bg-gradient-to-r hover:from-pink-500 hover:to-orange-400 rounded-lg" type="submit">Dismiss message</buton>
